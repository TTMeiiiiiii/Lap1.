...
public class MainActivity extends AppCompatActivity {
    ...
    public void goi_click(View view) {
        Intent myintent = new Intent(MainActivity.this,Chucnanggoi.class);
        startActivity(myintent);
    }

    public void nhan_click(View view) {
        Intent myintent2 = new Intent(MainActivity.this,chucnangnt.class);
